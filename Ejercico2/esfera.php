...
<div class="card text-center" style="width: 18rem; margin-left: 38%; margin-top: 5%;">
        ...
        <div class="card-body">
            <form method="POST" action="esfera.php">
                <div class="mb-3">
                    <label class="form-label">Ingrese el valor del radio (mm):</label>
...
<?php 
    if(isset($_POST['num'])){
        ...
        $area = 0;
        $area = 4 * PI * (pow($r,2));
        echo'<script language="javascript"> alert("El área de la esfera es: '.$area.' mm"); window.location.href="Ejercicio2.php";</script>';
    }
?>
